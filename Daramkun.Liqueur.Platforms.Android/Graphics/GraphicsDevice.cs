...
namespace Daramkun.Liqueur.Graphics
{
    class GraphicsDevice : IGraphicsDevice
    {
        ...
        public object Handle { get { return ( window.Handle as OpenTK.Platform.Android.AndroidGameView ).Context; } }
        ...
        {
            get { return ( FullscreenMode ) ? screenSize : ChangeToVector ( ( window.Handle as OpenTK.Platform.Android.AndroidGameView ).ClientSize ); }
            set
            {
                screenSize = value;
                ( window.Handle as OpenTK.Platform.Android.AndroidGameView ).ClientSize =
        ...
        public bool FullscreenMode
        {
            get
            {
                return ( window.Handle as OpenTK.Platform.Android.AndroidGameView ).WindowState == OpenTK.WindowState.Fullscreen;
            }
            set
            {
                ( window.Handle as OpenTK.Platform.Android.AndroidGameView ).WindowState = value ? OpenTK.WindowState.Fullscreen : OpenTK.WindowState.Normal;
                if ( value )
        ...
        public GraphicsDevice ( IWindow window )
        {
            ...
            ( window.Handle as OpenTK.Platform.Android.AndroidGameView ).Resize += ( object sender, EventArgs e ) =>
            {
        ...
        {
            ( window.Handle as OpenTK.Platform.Android.AndroidGameView ).SwapBuffers ();
        }
