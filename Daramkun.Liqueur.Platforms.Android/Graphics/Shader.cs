...
namespace Daramkun.Liqueur.Graphics
{
	class Shader : IShader
	{
		...
		private void SetShaderAndCompile ( string shaderCode )
		{
			...
			int compileState;
			GL.GetShader ( shaderId, All.CompileStatus, out compileState );
			if ( compileState == 0 )
			{
		...
		private OpenTK.Graphics.ES20.All ConvertShaderType ( Graphics.ShaderType shaderType )
		{
			switch ( shaderType )
			{
				case ShaderType.VertexShader: return OpenTK.Graphics.ES20.All.VertexShader;
				case ShaderType.PixelShader: return OpenTK.Graphics.ES20.All.FragmentShader;
				default: return ( OpenTK.Graphics.ES20.All ) ( -1 );
			}
		}
	}
}
