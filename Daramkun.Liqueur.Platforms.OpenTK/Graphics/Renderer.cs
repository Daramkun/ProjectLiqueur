...
namespace Daramkun.Liqueur.Graphics
{
	class Renderer : IRenderer, IDisposable
	{
		...
		{
			get { return window.window.WindowState == OpenTK.WindowState.Fullscreen; }
			set { window.window.WindowState = ( value ) ? OpenTK.WindowState.Fullscreen : OpenTK.WindowState.Normal; }
		}
