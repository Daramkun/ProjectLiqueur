...
{
	class LiqueurSpriteFontGenerator : ITool
	{
		[Flags]
		enum Charset : uint
		{
		...
		Point GetBoundingBox ( Bitmap charBitmap )
		{
		...
		Bitmap GetCharBitmap ( System.Drawing.Graphics tempGraphics, Font font, Brush whiteBrush, bool antialias, char ch, Color backgroundColor )
		{
			Size imageSize = GetFontSize ( tempGraphics, font, "" + ch );

			Bitmap charBitmap = new Bitmap ( imageSize.Width, imageSize.Height );
			System.Drawing.Graphics charGraphics = System.Drawing.Graphics.FromImage ( charBitmap );
			...
			charGraphics = System.Drawing.Graphics.FromImage ( charBitmap );
		...
		void AddFileToZipArchive ( ZipArchive archive, string filename, Stream data )
		{
		...
		public void Run ( params string [] args )
		{
			if ( args.Length == 0 || args [ 0 ] == "-h" || args.Length != 7 )
			{
				...
				Console.WriteLine ( "  lemon.exe -lsf dest fontname fontsize -[z|i] -[b|p] -[a|g] -[charset] chars" );
				Console.WriteLine ( "===============================================================================" );
